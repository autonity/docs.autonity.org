...
devenv_root = "/Users/spencerclearmatics/Code/docs.autonity.org-bakerloo-1";
devenv_dotfile = ./.devenv;
devenv_dotfile_string = ".devenv";
container_name = null;
devenv_tmpdir = "/var/folders/4s/jwyf7jxx4871fgmzkdgcgs6w0000gp/T/";
devenv_runtime = "/var/folders/4s/jwyf7jxx4871fgmzkdgcgs6w0000gp/T/devenv-caffc4a";
