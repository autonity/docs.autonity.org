...
linkTitle: "Setup NodeJS Console"
weight: 1000
description: >
  How to install and launch the NodeJS Console.
draft: true
---
...
{{< alert title="Warning" color="warning">}}The console remains in the codebase but is not officially supported. It may be used with this caveat.{{< /alert >}}
