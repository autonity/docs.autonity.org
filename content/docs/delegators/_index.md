...
The steps in this section describe how to carry out operations related to staking.  It is assumed that you have setup the `autcli` tool, has an [account](/account-holders/create-acct/) that is [funded](/account-holders/fund-acct/) and is able to submit transactions to the network.  See the [Account Holder Guide](/account-holders/) for details.
